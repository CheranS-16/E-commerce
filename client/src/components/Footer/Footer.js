        ...
        <footer>
            <div className="footer__container">
                    ...
                    <div className="footer__contact__container">
                        ...
                        <ul className="footer__contacts">
                            <li className="footer__contact">
                                <LocalPhoneIcon /> <span>+123 4567 888</span>
                            </li>
                            <li className="footer__contact">
                                <EmailIcon /> <span>shop@lifestyle.com</span>
                            </li>
                            <li className="footer__contact">
                                <LocationOnIcon /> <span>T Nagar, Chennai</span>
                            </li>
                        </ul>
                    </div>
                ...
                <div className="fotter__copyright__container">
                    <ul className='nav'>
                        <li className="footer__copyright">©2022 LifeStyle Ltd. |</li>
